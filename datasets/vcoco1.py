# only for generate pseudo-label
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        'val': (root / 'images' / 'train2014', root / 'annotations' / 'trainval_vcoco.json'),
    }
    # CORRECT_MAT_PATH = root / 'annotations' / 'corre_vcoco.npy'
    CORRECT_MAT_PATH = 'data/hico_20160224_det/annotations/corre_hico.npy'
